...
DOCKER_RUN_ARGS+=( -v $BWD/mnt/etc/openldap/slapd.conf:/etc/openldap/slapd.conf )
DOCKER_RUN_ARGS+=( -v $BWD/mnt/var/lib/openldap/openldap-data:/var/lib/openldap/openldap-data )
